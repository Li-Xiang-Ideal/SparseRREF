...
namespace SparseRREF {
	...
	template <typename T, typename index_t> struct sparse_tensor_struct {
		...
		// traverse entries with row index in range `[row_start, row_end)`
		...
		// traverse entries with row index in range `[row_start, row_end)` and return the used multithread blocks
		...
		// traverse entries with row index in range `[row_start, row_end)` using given multithread blocks
		template <typename F1, typename F2, typename F3>
